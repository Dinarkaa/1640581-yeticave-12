...
$user_name = 'Динар'; // укажите здесь ваше имя
?>
<!DOCTYPE html>
<html lang="ru">
<head>
    <meta charset="UTF-8">
    <title>Главная</title>
    <link href="../1640581-yeticave-12/css/normalize.min.css" rel="stylesheet">
    <link href="../1640581-yeticave-12/css/style.css" rel="stylesheet">
</head>
<body>
...
<header class="main-header">
    <div class="main-header__container container">
        ...
        <a class="main-header__logo">
            <img src="../1640581-yeticave-12/img/logo.svg" width="160" height="39" alt="Логотип компании YetiCave">
        </a>
...
<main class="container">
    ...
    <section class="lots">
        ...
        <ul class="lots__list">
            ...
            <?php
            $tabl5 = [["Название" => "2014 Rossignol District Snowboard",
